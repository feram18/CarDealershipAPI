...
public class SalesAssociateController extends EmployeeController<SalesAssociate> {
    private final EmployeeService<SalesAssociate> associateService;

    @Autowired
    public SalesAssociateController(EmployeeService<SalesAssociate> associateService) {
